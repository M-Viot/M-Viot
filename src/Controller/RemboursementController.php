...
{
    /**
     * @Route("/api", name="remboursement_api_index", methods={"GET"})
     */
    public function api(RemboursementRepository $remboursementRepository): Response
    {
        return $this->json($remboursementRepository->findBy(array(), array('dateReglement' => 'DESC')),200);
    }
    /**
